...
from dg_template.transforms.general import IdentityTransform
from dg_template.transforms.general import CutoutOnFloat


class Camelyon17Transform(nn.Module):
    
    # These are domain-wise statistics, which are currently not used.
    # Feel free to remove them at your will.
